...
export class WalletL2 extends AdapterL2 {
    ...
    constructor(privateKey, provider) {
        ...
        if (this._providerL2) {
            ...
            this._eip712Signer = new EIP712Signer(this._signerL2, network.then(n => Number(n.chainId)));
        }
    }
    /**
    ...
    static async fromEncryptedJson(json, password, callback) {
        const wallet = await ethers.Wallet.fromEncryptedJson(json, password, callback);
