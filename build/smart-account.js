...
class SmartAccount extends ethers_1.AbstractSigner {
     ...
     *
     * import { SmartAccount, Wallet, Provider, utils } from 'via-ethers';
     * import { ethers } from 'ethers';
     *
     * const ADDRESS = '<ADDRESS>';
     * const PRIVATE_KEY = '<PRIVATE_KEY>';
...
class ECDSASmartAccount {
     ...
     * @example
     *
     * import { ECDSASmartAccount, Provider, types } from 'via-ethers';
     *
     * const ADDRESS = '<ADDRESS>';
     * const PRIVATE_KEY = '<PRIVATE_KEY>';
     *
...
class MultisigECDSASmartAccount {
     ...
     * @example
     *
     * import { MultisigECDSASmartAccount, Provider, types } from 'via-ethers';
     *
     * const ADDRESS = '<ADDRESS>';
